...
class OrderItem {
  ...
  get price(): number { // pq setar o tipo aqui??
    return this._price;
  }
...
const sandwiche = new OrderItem('Sandwich Natural', 5.00);
const juice = new OrderItem('Suco de Abacaxi', 4.50);
...
console.log('Valor com desconto: ', order.discontOrderPrice());
